...
public class ItemsContract {
    ...
    static final String ITEMS_SEGMENT = "items";
	...
	public static class Items implements ItemsColumns {
		...
		public static Uri buildDirUri() {
			return BASE_URI.buildUpon().appendPath(ITEMS_SEGMENT).build();
		}

		/** Matches: /items/[_id]/ */
		public static Uri buildItemUri(final long _id) {
			return BASE_URI.buildUpon()
                    .appendPath(ITEMS_SEGMENT)
        ...
        public static long getItemId(final Uri itemUri) {
            ...
            return Long.parseLong(itemUri.getPathSegments().get(ITEM_ID_INDEX));
        }
	}
